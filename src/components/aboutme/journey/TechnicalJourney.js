  ...
  return (
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        icon={<ComputerIcon />}
      >
          <h3 className="vertical-timeline-element-title">Microsoft Word Excel Power Point </h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
        ...
        <VerticalTimelineElement
          ...
          icon={<ComputerIcon />}
        >
          <h3 className="vertical-timeline-element-title">Data Science</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
          ...
          icon={<DiMysql />}
        >
          <h3 className="vertical-timeline-element-title">MySQL/ MongoDB</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
