                        ...
                        <Col md={4}>
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://coursera.org/share/a26ff283f706616775258b7ca40b8592"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                        ...
                        <Col md={4}>
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://www.geeksforgeeks.org/courses/data-science-live"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                Complete Machine Learning & Data Science Program ( Course Link )
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                AI Tools & ChatGPT with MS Office
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
